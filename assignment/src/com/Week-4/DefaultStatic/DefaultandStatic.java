...
/*DefaultAndStatic is a class that implements StringOperations
 * Default methods can be override
 * and static methods cannot be override */
class DefaultAndStatic implements StringOperations {

    @Override
    public String concat(String input) {
        return input.concat(" Yeshwanth from override method");
    }
...
interface StringOperations {
    ...
    default String concat(String input) {
        return input.concat(" Yeshwanth from Default method");
    }
